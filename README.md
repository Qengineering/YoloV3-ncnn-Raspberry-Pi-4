...
## Dependencies.
### Due to a not yet solved compiler issue [#2812](https://github.com/Tencent/ncnn/issues/2812), use only ncnn version 20200916 or earlier!
```git clone -b 20200916 --depth 1 https://github.com/Tencent/ncnn.git```
